...
Creative Front-End Developer offering <CountYears from={2009} />+ years of experience developing for the web, using a variety of technologies that range from procedural libraries like jQuery—to MVC frameworks such as AngularJS—to modern component based frameworks like React, Angular and Vue. Focused on the web platform by leveraging JavaScript, HTML & CSS to build complex web apps that provide high-impact web solutions for diverse organizations.

## Skills

- Mastery of cross-browser JavaScript, HTML & CSS
- Advanced understanding of the JavaScript language, and its superset TypeScript
